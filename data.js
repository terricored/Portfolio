const artData = [
  ...
  },
  {
    ...
    medium: "Oil on Canvas",
    type: "contact",
    desc: "Available for freelance and full-time collaborations.",
    reactionImg: "shy.png",
    glitchGif: "test.gif",
    links: [
  ...
  },
  {
    ...
    medium: "Oil on Canvas",
    type: "chess",
    desc: "A chronological look at the development process.",
    rows: [
      {
        title: "Initial Sketches",
        desc: "The project started with rough conceptual layouts focusing on negative space.",
        media: [
          { type: "image", src: "nullimage@0,33x.png" }
        ]
      },
      {
        title: "Motion Studies",
        desc: "Testing how the elements react to user interaction and scroll speed.",
        media: [
          { type: "video", url: "https://www.youtube.com/embed/BHACKCNDMW8" }
        ]
      }
    ]
  }
